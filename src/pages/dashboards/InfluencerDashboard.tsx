      ...
      <main className="container py-6 space-y-6">
        <div className="flex items-center justify-between">
          <div>
            ...
            <p className="text-muted-foreground">Ready to grow your influence and earn more?</p>
          </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-4">
          <Card className="bg-gradient-to-br from-primary/10 to-primary/5 border-primary/20 hover:shadow-lg transition-all duration-200 border-l-4 border-l-primary">
            ...
            <CardContent>
              ...
              <div className="flex items-center text-xs text-green-600">
                ...
                <span className="font-medium">+25% from last month</span>
              </div>
            </CardContent>
          </Card>
